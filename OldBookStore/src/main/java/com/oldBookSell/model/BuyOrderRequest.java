...
@SequenceGenerator(name = "buy_order_sequence", initialValue = 20001, allocationSize = 1)
public class BuyOrderRequest {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "buy_order_sequence")
